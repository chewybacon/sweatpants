 ...
 * ```
 */
import { createPipeline } from '@sweatpants/react-chat/pipeline'
import type { PipelineConfig, Pipeline } from '@sweatpants/react-chat/pipeline'
...
export type {
  ...
  Processor,
  Pipeline,
} from '@sweatpants/react-chat/pipeline'
