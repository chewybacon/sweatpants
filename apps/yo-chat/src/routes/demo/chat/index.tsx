...
import { useChatSession } from '@tanstack/framework/react/chat'
...
function EffectionChatDemo() {
  // Dual buffer with paragraph settling is the default
  // @ts-ignore
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-4 flex justify-between text-xs text-slate-600 px-2">
          <button
            ...
            className="hover:text-slate-400 disabled:opacity-50"
          >
            Clear History
          </button>
          <span>
