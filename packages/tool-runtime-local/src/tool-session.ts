...
import { createBridgeHost, type ElicitResponse } from '@sweatpants/framework/chat/mcp-tools'
 ...
 */
interface LocalSampleResponse {
  result: RawSampleResult
}

interface PendingSample {
  id: string
  signal: Signal<LocalSampleResponse, void>
}
