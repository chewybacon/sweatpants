...
import type { ProcessorContext, ProcessedOutput, SettleContext } from '../types'

// Helper to run a processor through multiple contexts (simulating a stream)
async function runProcessorStream(
  processorFactory: () => ReturnType<typeof quickMermaidProcessor>,
...
function settleCode(chunks: string[]): Array<{ content: string; meta: any }> {
