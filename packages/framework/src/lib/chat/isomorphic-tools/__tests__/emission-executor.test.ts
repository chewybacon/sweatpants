...
import { run, createChannel, createSignal, spawn, each, sleep } from 'effection'
...
describe('Emission Executor Integration', () => {
  it('should emit tool_emission_start when executing a tool with emission channel', async () => {
  ...
  it('should send emissions through channel when ctx.render() is called', async () => {
