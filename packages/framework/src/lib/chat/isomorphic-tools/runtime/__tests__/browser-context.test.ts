...
describe('Browser Context', () => {
  describe('createBrowserContext', () => {
    it('should create context with render method', function* () {
    ...
    it('should track emissions in execution state', function* () {
    ...
    it('should use function name when displayName not set', function* () {
      const executionState = createExecutionState('call-1', 'test_tool')
    ...
    it('should include component reference in emission payload', function* () {
  ...
  describe('Fire-and-forget pattern', () => {
    it('should support components that resolve immediately', function* () {
  ...
  describe('waitFor method', () => {
    it('should delegate to runtime.emit', function* () {
      const config: RuntimeConfig = {
        handlers: {
      ...
      const result = yield* ctx.waitFor<{ data: string }, { custom: string; payload: unknown }>(
        'custom-type',
        { data: 'test' }
      )
  ...
  describe('Real-world tool pattern', () => {
    it('should support a card guessing game flow', function* () {
      ...
      const result = { guess, secret, correct }
